...
java $JMX_OPTIONS -Dvertx.logger-delegate-factory-class-name=io.vertx.core.logging.SLF4JLogDelegateFactory -jar clientes-1.0.0-SNAPSHOT-fat.jar -conf src/config/config.json  
